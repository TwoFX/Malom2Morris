...
const string movegen_file = (string)"D:\\Users\\marku\\Downloads\\Malom_source\\dataaux\\" + VARIANT_NAME + ".movegen"; //This file is created by the solver with the -writemovegenlookups switch. The Controller automatically makes this, if the file doesn't exist.
